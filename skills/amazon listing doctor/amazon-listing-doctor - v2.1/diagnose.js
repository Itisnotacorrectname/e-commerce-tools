#!/usr/bin/env node
// ─────────────────────────────────────────────────────────────
//  Amazon Listing Doctor — diagnose.js v2.1
//
...
// ── Phase 2 终止 ─────────────────────────────────────────────
// v2.1: Phase 2 改为在主 session 内执行分析，不再 spawn 子进程
// 后续步骤：
//   1. 读取 checkpoints/[ASIN]/step2.json + step4.json
//   2. 在主 session 写出 analysis.md（格式见 SKILL.md Phase 2）
//   3. node md_to_checkpoints.js [ASIN]
//   4. 在 reports/[ASIN]/ 运行 create_doc.js 创建飞书文档
