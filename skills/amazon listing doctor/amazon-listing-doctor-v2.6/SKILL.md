...
version: 2.6 -mimo
description: Diagnose any Amazon listing with a full competitive audit (Route B), Rufus intent simulation, Cosmo content scoring, rewritten bullet copy with Fact-Check, and category-weighted coreProduct extraction. Paste any amazon.com product link to run.
note: v2.6基于v2.3架构，加入v2.4的category-weighted核心产品提取优化，开源零依赖。
---
